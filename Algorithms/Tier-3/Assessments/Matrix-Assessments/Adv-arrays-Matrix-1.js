...
That is, for each element calculate the sum of all elements K distance away from this index in a square. 
Set that value in your answer matrix in the corresponding position.

Notice that for any k, the size of the area to be summed is a square of size 2k + 1 on each side. 
All of the positions in that area are distance k away from the center.
