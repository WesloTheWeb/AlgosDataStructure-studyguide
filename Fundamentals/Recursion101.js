...
/* Pure Recursion Tips
1. For arrays use methods like slice, the spread operator (...), and concat to make copies of arrays
so we do not mutate them.

2. Remember that strings are IMMUTABLE, so we will need to use methods like slice, substr, or substring to make copies
of strings.
