...
https://coda.io/d/Session-Handbook_d8riNzxISKj/September-22nd-4pm-PDT-w-Vinit_suHgY

Could you please explain suffix array and LCP array? It looks suffix arrays are   really helpful to solve Longest Common Substring and string related problems.
...
console.log(minSwaps([0, 0, 0, 1, 1, 0, 0]) == 4)
console.log(minSwaps([0, 0, 0, 1, 1, 1, 1]) == 0)
console.log(minSwaps([1, 1, 1, 1, 1, 1, 0]) == 0)
...
// console.log(minSwapsToGroupZerosAndOnes([0, 0, 0, 1, 1, 0, 0]) == 4)
// console.log(minSwapsToGroupZerosAndOnes([0, 0, 0, 1, 1, 1, 1]) == 0)
// console.log(minSwapsToGroupZerosAndOnes([1, 1, 1, 1, 1, 1, 0]) == 0)
// console.log(minSwapsToGroupZerosAndOnes([]) == 0)
