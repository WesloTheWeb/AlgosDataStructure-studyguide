...
function solution_recur(current) { //TreeNode()

    if (current != null && current.value) {
        console.log(current.value);

        solution_recur(current.left);
        solution_recur(current.right);
    }
...
console.log(solution_recur(tree2));
...
stack going down to the left side first
5
-3
1
2
 
stack going down to the right side next
-7
-10
9
