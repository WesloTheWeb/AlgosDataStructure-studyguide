...
Examples
patrons = ['Joe', 'Bart', 'Larry', 'Joe', 'Carl', 'Doug', 'Joe', 'Carl', 'Bart']
numPeople = 3
...
buckets = [0, 1, 2, 3, ...n]
buckets = [[], [Larry, Doug], [Bart, Carl], [Joe]]


[[], [Larry, Doug], [Bart, Carl], [Joe]]
[[], [Larry, Doug], [Bart, Carl], []]
...
function limitedServings(patrons, numberOfPeople) {
    ...
    */
    ...
    // [undefined, [larry, doug], [bart, cart]] << we want
  }
  ...
  */
  ...
  const patrons = ['Joe', 'Bart', 'Larry', 'Joe', 'Carl', 'Doug', 'Joe', 'Carl', 'Bart']
