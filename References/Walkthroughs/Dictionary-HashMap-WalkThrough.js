...
TYPE: Array Problems
########################################
Question: Given an array of positive integers, find the first element that occurs k number of times. 
...
Approach:
 1.) create dictionary keep track of the elments,
 2.) key: element and value: count of element number of times.
 3.) iterate through and then check if the element occured
 4.) return the element that occurred k times.
...
SETS
- Sets will give you a unique keys only.
set: 
...
// ALTERNATE APPROACH WITH FOREACH BUT MAY NOT WORK EXACTLY.
// TO-DO: Find out different of how ForEach works
